    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div className="p-8 text-center bg-blue-600">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Catatan Keuangan</h1>
          <p className="text-blue-100">Kelola keuangan Anda dengan mudah</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-slate-500">atau email</span>
              </div>
            </div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); onLogin('email'); }} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-slate-900 text-white font-medium py-3 px-4 rounded-xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-200"
              >
                Masuk
              </button>
            </form>
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            Belum punya akun? <span className="text-blue-600 font-medium cursor-pointer">Daftar sekarang</span>
          </p>
        </div>
      </div>
    </div>
